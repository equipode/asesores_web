...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div align="center" class="col-md-12">
				<h1><b>¿Qué tipos de sitios web<br>
				desarrollamos?</b></h1><br><br>

				<h2><b>¡Aquí te contamos!</b></h2>
			</div>
		</div>
	</div><br>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<img src="imgs/web-basic.png" alt="" width="350" height="420">
			</div>	

			<div class="col-md-4">
				<img src="imgs/web-popu.png" alt="" width="350" height="420">
			</div>	

			<div class="col-md-4">
				<img src="imgs/web-prem.png" alt="" width="350" height="420">
			</div>	
		</div>
	</div><br>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				<img src="imgs/imagen1.png" alt="" width="1200" height="500">
			</div>
		</div>
	</div><br>
